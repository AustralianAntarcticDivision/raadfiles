...
#' @export
#' @name nsidc
nsidc_cdr_daily_files <- function(extra_pattern = NULL) {

  pattern <- c("noaadata.apps.nsidc.org", "G02202_V6", "daily", "nc$", extra_pattern)
  final_files <- .find_files_generic(pattern)
...
#' @export
#' @name nsidc
nsidc_cdr_monthly_files <- function(extra_pattern = NULL) {
