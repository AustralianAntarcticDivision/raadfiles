...
1. Get a huge file collection. (You probably have lots, but see raadsync for an possible way forward if not).
2. Install `raadfiles`. 
...
```{r}
devtools::install_github("AustralianAntarcticDivsion/raadfiles")
```
